	...
	function ($) {
		...
		$.fn.calendar = function (opt, val) {
			...
			var btn1 = $('<button>')
				...
				.html("<span class='left_angle'><i class='fas fa-angle-left'></i></span>")
				.ripple()
			...
			var btn2 = $('<button>')
				.addClass('ic ic-arrow-angle-right rightarrow')
				.ripple()
				.attr('title', 'Next month')
				.html("<span class='right_angle'><i class='fas fa-angle-right'></i></span>")
				.click(function (e) {
					e.preventDefault();
					if (isMoving) return;
			...
			var btn3 = $('<button>')
				...
				.html("<button class='todays'>Today</button>")
				.click(function (e) {
					e.preventDefault();
					if (isMoving) return;
					var dt = new Date();
				...
				.focus(hideYearPicker)
			var btn4 = $('<button>')
				.addClass('btn ic ic-target d-none')
				.ripple()
